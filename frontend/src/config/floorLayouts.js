export const buildingLayouts = {
  "Bucharest": {
    ...
    "1": {
      ...
      rooms: {
        // Top row, left to right
        "1.01": { x: 0, y: 90, width: 132, height: 150, label: { x: 66, y: 75 } },           // Office
        "1.02": { x: 132, y: 90, width: 120, height: 150, label: { x: 192, y: 75 } },        // Server
        "1.03": { x: 252, y: 90, width: 114, height: 150, label: { x: 309, y: 75 } },        // Office
        "1.04": { x: 366, y: 90, width: 114, height: 150, label: { x: 423, y: 75 } },        // Office
        "1.05": { x: 480, y: 90, width: 114, height: 150, label: { x: 537, y: 75 } },        // Office
        "1.06": { x: 594, y: 90, width: 246, height: 150, label: { x: 717, y: 75 } },        // Office
      }
    }
  }
};